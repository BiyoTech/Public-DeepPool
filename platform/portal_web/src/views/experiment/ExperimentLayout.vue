      ...
      <aside class="w-48 flex-shrink-0">
        <nav class="bg-white rounded-xl border border-slate-200 overflow-hidden">
          <router-link
            ...
            :class="
              isActive(item.path) ? 'text-dp-blue bg-blue-50/60' : 'text-dp-muted hover:text-dp-title hover:bg-slate-50'
            "
          >
...
const OverviewIcon = {
  render: () =>
    h('svg', { class: 'w-4 h-4', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', 'stroke-width': '1.5' }, [
      h('path', {
